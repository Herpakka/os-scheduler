...
if __name__ == "__main__":
    ...
    for i in priority:
        jobs[i] = [
            int(i)
            for i in input(
                "Enter values for " + i + "(priority level " + str(priority[i]) + "): "
            ).split()
        ]

    turnaround_time = {
        "RR": [0] * len(jobs["RR"]),
        "SJF1": [0] * len(jobs["SJF1"]),
        "SJF2": [0] * len(jobs["SJF2"]),
        "FCFS": [0] * len(jobs["FCFS"]),
    }
    waiting_time = {
        "RR": [0] * len(jobs["RR"]),
        "SJF1": [0] * len(jobs["SJF1"]),
    ...
    for i in priority:
        print(
            "Priority level", priority[i], ":", ", ".join(str(i) for i in burst_time[i])
        )
    ...
    for i in priority:
        print(
            ...
            priority[i],
            ":",
            ", ".join(str(i) for i in turnaround_time[i]),
        )
    ...
    for i in priority:
        print(
            ...
            priority[i],
            ":",
            ", ".join(str(i) for i in waiting_time[i]),
        )
